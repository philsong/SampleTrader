...
DBsubServerIP = "10.68.89.100"
DBsubServerPort = 8198     #API connect to device
ApiReqServerHost = "10.68.89.100"
ApiReqServerPort = 8197
ApiRepServerHost = "10.68.89.100"
ApiRepServerPort = 8196     #API connect to device



Contracts0 = ('CLF6','CLG6','CLH6','CLJ6','CLK6','CLM6','CLN6','CLQ5','CLU5','CLV5','CLX5','CLZ5',
...
class APIServerThread(threading.Thread):
    ...
    def run(self):
        ...
        self.mySPAPI.SPAPI_SetLoginInfo('10.68.89.2', 8080, '123456', 'tianjun', 'TIM01', 'Tj700120')
